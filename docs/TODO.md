...
| PR | **PR #4 で main にマージ済み**（`78ec885`）・**Vercel 本番デプロイ済み**（2026-09-10） |
| docs 本体 | **2026-09-10 改訂済み**（`docs/level-100-spec-sync`） |
...
| # | 決定 |
|---|---|
| 1 | レベルを **Lv1〜100** に拡張し、ボスゲートを **Lv50 → 70 → 90 → 100**（初期キャップ50）に置く |
